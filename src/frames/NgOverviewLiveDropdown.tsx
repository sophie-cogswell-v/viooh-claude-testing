...
export default function NgOverviewLiveDropdown() {
  return (
    <div className="bg-[#efeff0] border border-[#e6e5e9] border-solid content-stretch flex items-center overflow-clip relative rounded-[8px] size-full" data-node-id="367:175862" data-name="PRG -> Deal Creation flow">
      ...
      <div className="absolute border border-[rgba(5,5,38,0.12)] border-solid content-stretch drop-shadow-[0px_3px_2px_rgba(16,16,52,0.06)] flex flex-col gap-[4px] items-start left-[1326px] p-[3px] rounded-[var(--radius\/md,6px)] top-[138px] w-[163px]" data-node-id="367:175966" data-name="menu list">
